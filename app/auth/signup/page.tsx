...
export default function RegisterPage() {
  return (
    <div className="bg-slate-50 dark:bg-black text-neutral-900 dark:text-white antialiased min-h-screen flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col justify-center py-24 sm:px-6 lg:px-8 relative overflow-hidden">
        {/* Background Blobs */}
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
          <div className="bg-white dark:bg-neutral-900 py-8 px-4 shadow-xl shadow-neutral-200/50 dark:shadow-none sm:rounded-2xl sm:px-10 border border-neutral-200 dark:border-neutral-800">
