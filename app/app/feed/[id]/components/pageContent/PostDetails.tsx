        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="border-b border-zinc-200 dark:border-zinc-800 pb-8">
            ...
            <div className="max-w-none text-zinc-600 dark:text-zinc-300">
              <p className="mb-4">
                Experience the serenity of the Colorado mountains with this
                exceptional 5-acre parcel. Situated just minutes from town but
                feeling worlds away, this property offers the perfect balance of
                accessibility and privacy. The terrain is gently rolling with a
                mix of open meadow and mature pine trees, providing multiple
                excellent building sites for your dream cabin or permanent
                residence.
              </p>
              <p className="mb-4">
                ...
                runs through the northern edge of the property, attracting local
                wildlife including elk and mule deer.
              </p>
              <p>
                Enjoy panoramic views of the Sangre de Cristo mountain range.
                This area is known for its dark skies, making it perfect for
                stargazing. No HOA, so bring your RV for weekend getaways while
                you plan your build!
              </p>
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-5 flex items-center gap-4">
              <div className="size-12 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 font-bold border border-blue-200 flex-shrink-0">
                RP
              </div>
