...
export default function WhoAreWe() {
  return (
    <div className="max-w-6xl mx-auto px-6  flex flex-col gap-16">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden rounded-3xl bg-gray-900 min-h-[400px] flex items-center p-10 shadow-lg">
        <img
        ...
        <div className="relative z-10 max-w-2xl text-white">
          ...
          <p className="text-gray-200 mb-8">
            Acreditamos que a terra é o investimento mais sólido e o espaço onde o futuro acontece.
          </p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            ...
            Focamos exclusivamente em propriedades rurais e terrenos de larga escala.
          </p>

          <p className="text-gray-600">
            Nossa plataforma é baseada em transparência, com dados claros e verificados
